...
public class Table2DbPojo {
	...
	public static void main(String[] args) throws Exception {
		...
		writeLine("import com.kingston.orm.annotation.Column;");
		writeLine("import com.kingston.orm.annotation.Entity;");
		writeLine("import com.kingston.orm.annotation.Id;");

...
public class TypeScriptProtocolGenerator extends ProtocolDocGenerator {
    ...
    private void export0(ProtocolFileDoc protocolFileDoc) throws Exception {
        ...
        // 获取模板文件
        Template template = cfg.getTemplate("typescriptprotocol.ftl");
        String newDirectory = "game_protocol/typescript/";
        // 上两层包名作为目录
        ...
        dataModel.put("classComment", protocolFileDoc.getDesc());
        ...
        FileWriter out = new FileWriter(newDirectory + "/" + protocolFileDoc.getName() + ".ts");
    ...
    private static String fieldOfTypeScript(Field field) {
        ...
        if (Collection.class.isAssignableFrom(type)) {
            ...
            return "Array<" + java2TypeScript(eleType) + ">";
            ...
            return "Map<" + java2TypeScript(keyType) + ", " + java2TypeScript(valueType) + ">";
        }
        return java2TypeScript(type);
    }

    private static String java2TypeScript(Class<?> type) {

...
public class Table2DbPojo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Connection conn = DbUtils.getConnection(DbUtils.DB_USER).getDataSource().getConnection();
    ...
    private static void writeGetter(Column c) {
        ...
        writeLine("public " + jdbcType2JavaType.get(type) +
                " get" + StringUtil.firstLetterToUpperCase(name) + " {");
    ...
    private static void writeSetter(Column c) {
        String name = c.name;
        String type = c.type;
        writeLine("public void set" + StringUtil.firstLetterToUpperCase(name) +
